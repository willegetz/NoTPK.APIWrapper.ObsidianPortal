...
namespace NoTPK.APIWrapper.ObsidianPortal
{
	public class ApiCalls
	{
		...
		public static async Task<string> ShowByCampaignSlug(string appId, string appSecret, string accessToken, string accessTokenSecret, string slug)
		{
			...
			var requestMessage = GetAuthorizationHeader(appId, appSecret, accessToken, accessTokenSecret, showUrl, HttpMethod.Get,"?use_slug=true", optionalParams);
			return await RetrieveDataFromGet(requestMessage);
		}
		...
		public static async Task<string> IndexCharactersByCampaignId(string appId, string appSecret, string token, string tokenSecret, string campaignId)
		{
			...
			var requestMessage = GetAuthorizationHeader(appId, appSecret, token, tokenSecret, indexUrl, HttpMethod.Get);
			return await RetrieveDataFromGet(requestMessage);
		}
		...
		public static async Task<string> ShowCharacterByCampaignIdCharacterSlug(string appId, string appSecret, string token, string tokenSecret, string campaignId, string slug)
		{
			...
			var requestMessage = GetAuthorizationHeader(appId, appSecret, token, tokenSecret, showUrl, HttpMethod.Get, "?use_slug=true", optionalParams);
			return await RetrieveDataFromGet(requestMessage);
		}
